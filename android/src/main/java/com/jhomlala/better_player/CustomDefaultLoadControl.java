...
class CustomDefaultLoadControl {
    ...
    CustomDefaultLoadControl(
        ...
        this.bufferForPlaybackMs = bufferForPlaybackMs != null ? bufferForPlaybackMs : DefaultLoadControl.DEFAULT_BUFFER_FOR_PLAYBACK_MS;
        this.bufferForPlaybackAfterRebufferMs = bufferForPlaybackAfterRebufferMs != null ? bufferForPlaybackAfterRebufferMs :
