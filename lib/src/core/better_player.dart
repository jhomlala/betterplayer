...
class BetterPlayerState extends State<BetterPlayer> with WidgetsBindingObserver {
  ...
  AnimatedWidget _defaultRoutePageBuilder(BuildContext context, Animation<double> animation, Animation<double> secondaryAnimation,
