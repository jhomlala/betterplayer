...
class BetterPlayerHlsUtils {
  ...
  static Future<List<BetterPlayerHlsTrack>> parseTracks(String masterPlaylistUrl) async {
  ...
  static Future<BetterPlayerHlsSubtitle> _parseSubtitlesPlaylist(Rendition rendition) async {
    ...
    try {
      ...
      return BetterPlayerHlsSubtitle(
          name: rendition.format.label, language: rendition.format.language, url: rendition.url.toString(), realUrls: hlsSubtitlesUrls);
    } catch (exception) {
