    ...
    try {
      ...
      adaptationSets.forEach((node) {
        try {
          ...
          if (MimeTypes.isVideo(mimeType) || expectedContentType == ExpectedContentType.video) {
            tracks = tracks + parseVideo(node);
          } else if (MimeTypes.isAudio(mimeType) || expectedContentType == ExpectedContentType.audioOnly) {
