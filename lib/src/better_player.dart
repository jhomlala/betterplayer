...
typedef Widget BetterPlayerRoutePageBuilder(
    ...
    _BetterPlayerControllerProvider controllerProvider);
...
class BetterPlayerState extends State<BetterPlayer> {
  ...
  Widget build(BuildContext context) {
    return _BetterPlayerControllerProvider(
  ...
  Widget _fullScreenRoutePageBuilder(
    ...
    var controllerProvider = _BetterPlayerControllerProvider(
      controller: widget.controller,
      child: PlayerWithControls(),
    );
...
class BetterPlayerController extends ChangeNotifier {
  ...
  static BetterPlayerController of(BuildContext context) {
    final chewieControllerProvider =
        context.inheritFromWidgetOfExactType(_BetterPlayerControllerProvider)
            as _BetterPlayerControllerProvider;
...
class _BetterPlayerControllerProvider extends InheritedWidget {
  const _BetterPlayerControllerProvider({
    Key key,
  ...
  @override
  bool updateShouldNotify(_BetterPlayerControllerProvider old) =>
