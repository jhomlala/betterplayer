///Android specific settings which will only be applied to android devices
///Currently contains variables which enable developers to create a better buffering experience
///when trying to buffer multiple videos are trying to quickly load and play a large video

class BetterPlayerAndroidConfiguration {
  ...
  const BetterPlayerAndroidConfiguration(
      ...
      this.bufferForPlaybackAfterRebufferMs = DEFAULT_BUFFER_FOR_PLAYBACK_AFTER_REBUFFER_MS});
}
