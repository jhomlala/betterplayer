...
class PlayerSubtitle {
  factory PlayerSubtitle(String value, bool isWebVTT) {
    try {
  ...
  static PlayerSubtitle _handle2LinesSubtitles(List<String> scanner) {
    try {
  ...
  @override
  String toString() {
    return 'PlayerSubtitle{index: $index, start: $start, end: $end, texts: $texts}';
  }
}
